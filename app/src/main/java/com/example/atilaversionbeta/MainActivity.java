...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, iComunicaFragments {
    ...
    public void guardarArtesania(){
        ...
        values.put(AtilaBD.FOTO_ACTIVIDAD, R.drawable.artesania);
        values.put(AtilaBD.IMG_DETALLE_ACTIVIDAD, R.drawable.artesaniadescrip);
    ...
    public void guardarParranda(){
        ...
        values.put(AtilaBD.FOTO_ACTIVIDAD, R.drawable.parrandavallenata);
        values.put(AtilaBD.IMG_DETALLE_ACTIVIDAD, R.drawable.parrandavallenatades);
    ...
    public void guardarNadarRio(){
        ...
        values.put(AtilaBD.FOTO_ACTIVIDAD, R.drawable.rioguatapuri);
        values.put(AtilaBD.IMG_DETALLE_ACTIVIDAD, R.drawable.riodescrip);
    ...
    public void guardarCityTour(){
        ...
        values.put(AtilaBD.FOTO_ACTIVIDAD, R.drawable.cititour);
        values.put(AtilaBD.IMG_DETALLE_ACTIVIDAD, R.drawable.citytourdescrip);
    ...
    public void guardarRestauranteMontaCarga(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.resmontacarga);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.montacargardescr);
    ...
    public void guardarRestauranteCafe(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.resartesano);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.artesanodescrip);
    ...
    public void guardarRestauranteCompae(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.rescompae);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.compaechiputodescrip);
    ...
    public void guardarHotelHilton(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.hotelhampton);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.hamptondescrip);
    ...
    public void guardarHotelSonesta(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.hotelsonesta);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.sonestadescrip);
    ...
    public void guardarHotelCasa(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.hotelcasareyes);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.casadelossantosdescrip);
    ...
    public void guardarWinners(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.barwinners);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.winnersdescr);
    ...
    public void guardarPremiere(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.lapremier);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.lapremierdescrip);
    ...
    public void guardarParqueProvincia(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.laprovincia);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.laprovinciadescrip);
    ...
    public void guardarPolicia(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.policia);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.policiadescrip);
    ...
    public void guardarBomberos(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.bomberos);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.bomberosdescrip);
    ...
    public void guardarHospitalRosario(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.hospitalrosario);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.hospitalrosariodescrip);
    ...
    public void guardarHospitalEduardo(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.hospitaleduardo);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.hospitaleduardodescri);
    ...
    public void guardarPlaza(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.plazaalfonsolopez);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.plazaalfonsolopezdesc);
    ...
    public void guardarRio(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.rioguatapuri);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.riodescrip);
    ...
    public void guardarGlorietaAcordion(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.pedazodeacordeon);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.pedazodeacordeondescrip);
    ...
    public void guardarGlorietaJuglares(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.losjuglares);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.losjuglaresdesrip);
    ...
    public void guardarLosPoporos(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.lospoporos);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.lospoporosdescri);
    ...
    public void guardarMuseoAcordeon(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.museodelacordeon);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.museodelacordeondescri);
    ...
    public void guardarPilonera(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.piloneramayor);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.piloneramayordesdes);
    ...
    public void guardarParqueLeyenda(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.parqueleyenda);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.parquedelayendadesc);
    ...
    public void guardarObelisco(){
        ...
        values.put(AtilaBD.FOTO_SITIO, R.drawable.obelisco);
        values.put(AtilaBD.IMG_DETALLE_SITIO, R.drawable.obeliscodesc);
    ...
    public void guardarFestival(){
        ...
        values.put(AtilaBD.FOTO_EVENTO, R.drawable.festivalvallenato);
    ...
    private void guardarLeyendaVallenata() {
        ...
        values.put(AtilaBD.FOTO_INFORMACION, R.drawable.leyendavallenata);
        values.put(AtilaBD.IMG_DETALLE_INFORMACION, R.drawable.leyendavallenatadescr);
    ...
    private void guardarLeyendaSirena() {
        ...
        values.put(AtilaBD.FOTO_INFORMACION, R.drawable.sirenahurtado);
        values.put(AtilaBD.IMG_DETALLE_INFORMACION, R.drawable.sirenadehurtadodescr);
    ...
    private void guardarLeyendaFrancisco() {
        ...
        values.put(AtilaBD.FOTO_INFORMACION, R.drawable.franciscoelhombre);
        values.put(AtilaBD.IMG_DETALLE_INFORMACION, R.drawable.franciscodescri);
    ...
    private void guardarEcceHomo() {
        ...
        values.put(AtilaBD.FOTO_INFORMACION, R.drawable.eccehomo);
        values.put(AtilaBD.IMG_DETALLE_INFORMACION, R.drawable.eccehomodescrip);
    ...
    private void guardarJuglarTobias() {
        ...
        values.put(AtilaBD.FOTO_INFORMACION, R.drawable.tobiasjuglar);
        values.put(AtilaBD.IMG_DETALLE_INFORMACION, R.drawable.tobiasdescrip);
